...
#[cfg(any(feature = "testing", test))]
pub use transaction_config::{DEFAULT_MAX_PAYMENT_MOTES, DEFAULT_MIN_TRANSFER_MOTES, DEFAULT_INSTALL_UPGRADE_GAS_LIMIT, DEFAULT_LARGE_TRANSACTION_GAS_LIMIT};
...
pub use vm_config::{
    ...
    DEFAULT_GLOBAL_COST, DEFAULT_GROW_MEMORY_COST,
