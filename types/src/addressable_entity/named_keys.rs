...
mod tests {
    ...
    fn should_match_field_names() {
        // this test was written to ensure that the schema generated by schemars matches the serde encoding,
        // both are configured using attributes and they can get out of sync
        let mut named_keys = NamedKeys::new();
