...
/// Named constant for method `get_rewards_purse`.
///
/// Only administrator accounts can call this entrypoint.
pub const METHOD_GET_REWARDS_PURSE: &str = "get_rewards_purse";
...
/// Storage for mint rewards purse key.
pub const REWARDS_PURSE_KEY: &str = "rewards";
