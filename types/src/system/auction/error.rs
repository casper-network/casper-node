...
pub enum Error {
    ...
    /// ```
    /// # use casper_types::system::auction::Error;
    /// assert_eq!(54, Error::InactiveValidatorUndelegationDelayTooLarge as u8);
    /// ```
    InactiveValidatorUndelegationDelayTooLarge = 54,
}
...
impl Display for Error {
    fn fmt(&self, formatter: &mut Formatter) -> fmt::Result {
        match self {
            ...
            Error::InactiveValidatorUndelegationDelayTooLarge => formatter.write_str("Inactive validator undelegation delay exceeds global limit"),
        }
    }
}
...
impl TryFrom<u8> for Error {
    ...
    fn try_from(value: u8) -> result::Result<Self, Self::Error> {
        match value {
            ...
            d if d == Error::InactiveValidatorUndelegationDelayTooLarge as u8 => {
                Ok(Error::InactiveValidatorUndelegationDelayTooLarge)
            }
