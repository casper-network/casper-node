...
pub enum Error {
    ...
    /// The delegated amount if below the minimum allowed amount.
    /// ```
    /// # use casper_types::system::auction::Error;
...
impl Display for Error {
    fn fmt(&self, formatter: &mut Formatter) -> fmt::Result {
        match self {
            ...
            Error::DelegationAmountTooSmall => formatter.write_str("The delegated amount if below the minimum allowed amount"),
