...
impl TransactionV1 {
    ...
    pub fn footprint(&self, system_config: SystemConfig) -> Result<TransactionV1Footprint, TransactionV1Error> {
        ...
        let gas_estimate = match category {
            ...
            TransactionV1Category::Staking => {
                system_config.auction_costs().delegate as u64
            }
            TransactionV1Category::Transfer => {
                system_config.wasmless_transfer_cost() as u64
            }
        };
