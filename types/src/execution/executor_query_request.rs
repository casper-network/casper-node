...
pub struct ExecutorQueryRequest {
...
impl ToBytes for ExecutorQueryRequest {
...
impl FromBytes for ExecutorQueryRequest {
...
pub struct ExecutorQueryResult {
    ...
    pub error: Option<()>, //  TODO: Pick an appropriate error type
...
impl ExecutorQueryRequestBuilder {
    ...
    pub fn build(self) -> Result<ExecutorQueryRequest, &'static str> {
