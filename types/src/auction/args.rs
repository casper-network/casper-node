...
/// Named constant for `validator_account_hash`.
pub const ARG_VALIDATOR_ACCOUNT_HASH: &str = "validator_account_hash";
/// Named constant for `delegator_account_hash`.
pub const ARG_DELEGATOR_ACCOUNT_HASH: &str = "delegator_account_hash";
