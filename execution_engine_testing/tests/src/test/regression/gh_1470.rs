...
use casper_types::{
    ...
    AccessRights, CLValue, ContractHash, ContractPackageHash, EraId, Key, ProtocolVersion,
...
// TODO add chainspec variable to toggle parameters check
...
//         let args = runtime_args! {
//             gh_1470_regression_call::ARG_TEST_METHOD =>
// gh_1470_regression_call::METHOD_CALL_VERSIONED_DO_NOTHING_OPTIONAL_TYPE_MISMATCH,
// gh_1470_regression_call::ARG_CONTRACT_PACKAGE_HASH => contract_package_hash,         };
//         ExecuteRequestBuilder::standard(*DEFAULT_ACCOUNT_ADDR, GH_1470_REGRESSION_CALL, args)
//             .build()
//     };
