...
fn host_function_metrics_has_acceptable_gas_cost() {
    ...
    builder.exec_instrumented(exec_request, instrumented!());
...
fn setup() -> InMemoryWasmTestBuilder {
    ...
    builder
        ...
        .exec_instrumented(create_account_exec_request(ACCOUNT0_ADDR), instrumented!())
        .expect_success()
        .commit()
        .exec_instrumented(create_account_exec_request(ACCOUNT1_ADDR), instrumented!())
        .expect_success()
        .commit();
    builder
}
