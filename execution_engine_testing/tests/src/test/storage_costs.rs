...
fn should_measure_gas_cost_for_storage_usage_write() {
    ...
    let small_write_function_cost = {
        ...
        builder_a
            .exec_instrumented(small_write_exec_request, instrumented!())
            .expect_success()
            .commit();
    ...
    let large_write_function_cost = {
        ...
        builder_b
            .exec_instrumented(large_write_exec_request, instrumented!())
            .expect_success()
            .commit();
...
fn should_measure_gas_cost_for_storage_usage_add() {
    ...
    let small_add_function_cost = {
        ...
        builder_a
            .exec_instrumented(small_add_exec_request, instrumented!())
            .expect_success()
            .commit();
