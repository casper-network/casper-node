...
fn faucet_costs() {
    ...
    const EXPECTED_FAUCET_INSTALL_COST: u64 = 147_139_816_256;
    const EXPECTED_FAUCET_INSTALL_COST_ALT: u64 = 158_323_799_135;

    const EXPECTED_FAUCET_SET_VARIABLES_COST: u64 = 79_475_715;

    const EXPECTED_FAUCET_CALL_BY_INSTALLER_COST: u64 = 2_652_630_718;

    const EXPECTED_FAUCET_CALL_BY_USER_COST: u64 = 2_558_336_051;
