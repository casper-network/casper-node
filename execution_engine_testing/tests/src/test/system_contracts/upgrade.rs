...
use casper_execution_engine::{
    ...
    shared::{
        ...
        opcode_costs::{
            BrTableCost, ControlFlowCost, OpcodeCosts, DEFAULT_ADD_COST, DEFAULT_BIT_COST,
            DEFAULT_BR_TABLE_MULTIPLIER, DEFAULT_CONST_COST, DEFAULT_CONTROL_FLOW_BLOCK_OPCODE,
            ...
            DEFAULT_STORE_COST, DEFAULT_UNREACHABLE_COST,
        },
    ...
    let opcode_cost = OpcodeCosts {
        ...
        control_flow: ControlFlowCost {
            ...
            br_table: BrTableCost {
                ...
                size_multiplier: DEFAULT_BR_TABLE_MULTIPLIER + 1,
            },
