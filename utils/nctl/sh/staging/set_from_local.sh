...
function _main()
{
    ...
    set_stage_binaries "$NCTL_CASPER_HOME" "$NCTL_CASPER_CLIENT_HOME" "$NCTL_CASPER_SIDECAR_HOME"
    set_stage_files_from_repo "$NCTL_CASPER_HOME" "$NCTL_CASPER_CLIENT_HOME" "$NCTL_CASPER_SIDECAR_HOME" "$PATH_TO_STAGE"
}
