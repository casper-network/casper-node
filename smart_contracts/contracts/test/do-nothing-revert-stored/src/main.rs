...
use casper_types::{
    ...
    ApiError, CLType, EntryPointAccess, EntryPointPayment, EntryPointType, Key,
};

const ENTRY_FUNCTION_NAME: &str = "delegate";
const HASH_KEY_NAME: &str = "do_nothing_revert_stored_hash";
const PACKAGE_HASH_KEY_NAME: &str = "do_nothing_revert_package_hash";
const ACCESS_KEY_NAME: &str = "do_nothing_revert_stored_access";
