...
use casper_types::{
    ...
    Chainspec, ContextAccessRights, CoreConfig, EntityAddr, FeeHandling, Key, Phase,
    ProtocolVersion, PublicKey, RefundHandling, RuntimeFootprint, StoredValue, TransactionHash,
    Transfer, URef, U512,
};
