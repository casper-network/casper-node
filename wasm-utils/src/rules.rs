...
pub struct Set {
    regular: u32,
    entries: BTreeMap<InstructionType, Metering>,
    grow: u32,
}
...
impl Set {
    pub fn new(regular: u32, entries: BTreeMap<InstructionType, Metering>) -> Self {
        Set {
            regular,
            entries,
            grow: 0,
    ...
    pub fn with_forbidden_floats(mut self) -> Self {
        self.entries
            .insert(InstructionType::Float, Metering::Forbidden);
        self.entries
            .insert(InstructionType::FloatComparison, Metering::Forbidden);
        self.entries
            .insert(InstructionType::FloatConst, Metering::Forbidden);
        self.entries
            .insert(InstructionType::FloatConversion, Metering::Forbidden);
        self
    }
}
