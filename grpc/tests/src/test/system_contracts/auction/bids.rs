...
use casper_types::{
    ...
    auction::{
        ...
        DEFAULT_UNBONDING_DELAY, DELEGATORS_KEY, ERA_ID_KEY, ERA_VALIDATORS_KEY,
        METHOD_RUN_AUCTION, UNBONDING_PURSES_KEY,
    },
...
fn should_run_add_bid() {
    ...
    assert_eq!(
        ...
        DEFAULT_INITIAL_ERA_ID + DEFAULT_UNBONDING_DELAY,
    );
}
...
fn should_calculate_era_validators_multiple_new_bids() {
    ...
    assert_eq!(
        ...
        builder.get_era_validators(DEFAULT_INITIAL_ERA_ID).unwrap()
    );
