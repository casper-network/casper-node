...
#![doc(html_root_url = "https://docs.rs/casper-engine-test-support/0.1.0")]
#![doc(
...
pub const DEFAULT_ACCOUNT_INITIAL_BALANCE: u64 = 50_000_000_000_000u64;

/// Minimal amount for a transfer that creates new accounts.
pub const MINIMUM_ACCOUNT_CREATION_BALANCE: u64 = 500_000_000_000u64;
