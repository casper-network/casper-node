...
impl WasmV1Request {
    /// Returns new instance of PayRequest.
    pub fn new(
        state_hash: Digest,
        protocol_version: ProtocolVersion,
        blocktime: BlockTime,
...
impl ToBytes for WasmV1Request {
    ...
    fn serialized_length(&self) -> usize {
        ToBytes::serialized_length(&self.state_hash)
            ...
            + ToBytes::serialized_length(&self.blocktime)
            + ToBytes::serialized_length(&self.protocol_version)
    ...
    fn write_bytes(&self, writer: &mut Vec<u8>) -> Result<(), bytesrepr::Error> {
        ...
        self.blocktime.write_bytes(writer)?;
...
impl WasmV1Result {
    ...
    /// Root not found.
    pub fn root_not_found(request: WasmV1Request, state_hash: Digest) -> Self {
        WasmV1Result {
    ...
    pub fn precondition_failure(request: WasmV1Request, error: EngineError) -> Self {
        WasmV1Result {
            transfers: Vec::default(),
            effects: Effects::new(),
            messages: Vec::default(),
    ...
    pub fn invalid_executable_item(request: WasmV1Request) -> Self {
        WasmV1Result {
            transfers: Vec::default(),
            effects: Effects::new(),
            messages: Vec::default(),
    ...
    pub fn execution_result(request: WasmV1Request, execution_result: ExecutionResult) -> Self {
