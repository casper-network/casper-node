...
//! use casper_execution_engine::shared::newtypes::Digest;
...
//!
//! // Get their hashes
//! let leaf_1_hash = Digest::new(&leaf_1.to_bytes().unwrap());
//! let leaf_2_hash = Digest::new(&leaf_2.to_bytes().unwrap());
//!
//! // Create a node
...
//!
//! // Get its hash
//! let node_hash = Digest::new(&node.to_bytes().unwrap());
//!
