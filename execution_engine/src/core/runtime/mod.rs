    ...
    pub fn call_host_mint(
        ...
        let result = match entry_point_name {
            ...
            mint::METHOD_MINT => (|| {
                ...
                saved_call_cost = Some(mint_costs.mint);
            ...
            mint::METHOD_REDUCE_TOTAL_SUPPLY => (|| {
                ...
                saved_call_cost = Some(mint_costs.reduce_total_supply);
            ...
            mint::METHOD_CREATE => (|| {
                ...
                saved_call_cost = Some(mint_costs.create);
            ...
            mint::METHOD_BALANCE => (|| {
                ...
                saved_call_cost = Some(mint_costs.balance);
            ...
            mint::METHOD_TRANSFER => (|| {
                ...
                saved_call_cost = Some(mint_costs.transfer);
            ...
            mint::METHOD_READ_BASE_ROUND_REWARD => (|| {
                ...
                saved_call_cost = Some(mint_costs.read_base_round_reward);
        ...
        // contract.
        if let Some(gas_cost) = saved_call_cost {
            self.gas(gas_cost.into())?;
        }
    ...
    pub fn call_host_proof_of_stake(
        ...
        let result = match entry_point_name {
            proof_of_stake::METHOD_GET_PAYMENT_PURSE => (|| {
                ...
                saved_call_cost = Some(pos_costs.get_payment_purse);
            ...
            proof_of_stake::METHOD_SET_REFUND_PURSE => (|| {
                ...
                saved_call_cost = Some(pos_costs.set_refund_purse);
            ...
            proof_of_stake::METHOD_GET_REFUND_PURSE => (|| {
                ...
                saved_call_cost = Some(pos_costs.get_refund_purse);
            ...
            proof_of_stake::METHOD_FINALIZE_PAYMENT => (|| {
                ...
                saved_call_cost = Some(pos_costs.finalize_payment);
    ...
    pub fn call_host_auction(
        ...
        let result = match entry_point_name {
            auction::METHOD_GET_ERA_VALIDATORS => (|| {
                ...
                saved_call_cost = Some(runtime.context.gas_counter());
