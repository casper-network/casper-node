...
use casper_types::{
    ...
    auction::{
        ...
        ARG_TARGET_PURSE, ARG_UNBOND_PURSE, ARG_VALIDATOR, ARG_VALIDATOR_PUBLIC_KEY,
        AUCTION_DELAY_KEY, BIDS_KEY, DELEGATOR_REWARD_PURSE_KEY, ERA_ID_KEY, INITIAL_ERA_ID,
