...
impl EngineConfigBuilder {
    ...
    #[deprecated(
        since = "3.0.0",
        note = "config option `max_stored_value_size` is obsolete and has no effect"
    )]
    pub fn with_max_stored_value_size(self, _max_stored_value_size: u32) -> Self {
        self
    }
    ...
    #[deprecated(
        since = "3.0.0",
        note = "config option `max_delegator_size_limit` is obsolete and has no effect"
    )]
    pub fn with_max_delegator_size_limit(self, _max_delegator_size_limit: u32) -> Self {
        self
    }
    ...
    /// Sets the vesting schedule period config option.
