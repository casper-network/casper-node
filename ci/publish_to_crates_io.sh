...
# smart_contracts/sdk_sys (casper-contract-sdk-sys) -> None
publish smart_contracts/sdk_sys

# executor/wasm_common (casper-executor-wasm-common)
...
# smart_contracts/sdk_codegen (casper-contract-sdk-codegen)
#     casper-contract-sdk
publish smart_contracts/sdk_codegen

# executor/wasm_interface (casper-executor-wasm-interface)
#     casper-executor-wasm-common
#     casper-storage
#     casper-types
publish executor/wasm_interface

# executor/wasm_host (casper-executor-wasm-host)
...
# executor/wasmer_backend (casper-executor-wasmer-backend)
#     casper-executor-wasm-common
