...
use casper_types::{
    ...
    ExecutableDeployItemIdentifier, FinalizedApprovals, InitiatorAddr, Key, Package, PackageAddr,
    PackageHash, PackageIdentifier, ProtocolVersion, Transaction, TransactionConfig,
