...
lazy_static! {
    ...
    static ref DOCS_RPC_RESULT: ListRpcsResult = {
        let mut result = ListRpcsResult {
...
/// Result for "list_get_rpcs" RPC response.
#[derive(Debug, Serialize, Deserialize)]
...
impl RpcWithoutParams for ListRpcs {
    const METHOD: &'static str = "list_get_rpcs";
...
impl RpcWithoutParamsExt for ListRpcs {
    fn handle_request<REv: ReactorEventT>(
        ...
        async move {
            let result = ListRpcsResult::doc_example();
