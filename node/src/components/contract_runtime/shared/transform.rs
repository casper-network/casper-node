...
use crate::components::contract_runtime::shared::{stored_value::StoredValue, TypeMismatch};
...
pub mod gens {
    ...
    use super::Transform;
    use crate::components::contract_runtime::shared::stored_value::gens::stored_value_arb;
