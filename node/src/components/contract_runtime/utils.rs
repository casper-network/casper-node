        ...
        let switch_block_utilization_score = {
            let has_hit_slot_limt = {
                (executable_block.mint().len() as u32 >= block_max_mint_count)
                    ...
                    || (executable_block.large().len() as u32 >= block_max_large_count)
                    || (executable_block.medium().len() as u32 >= block_max_medium_count)
                    || (executable_block.small().len() as u32 >= block_max_small_count)
