...
<<<<<<< HEAD:node/src/components/consensus/protocols/highway/synchronizer/tests.rs
    protocols::highway::tests::NodeId,
=======
>>>>>>> release-1.3.0:node/src/components/consensus/highway_core/synchronizer/tests.rs
    BlockContext,
};
