...
pub use deploy::{
    Approval, Deploy, DeployConfigurationFailure, FinalizedApprovalsWithId, DeployHash,
    DeployHeader, DeployMetadata, DeployMetadataExt, DeployOrTransferHash, DeployWithApprovals,
