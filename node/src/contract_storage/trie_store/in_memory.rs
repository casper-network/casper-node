...
//!
//! ```
//! use casperlabs_node::contract_storage::store::Store;
//! use casperlabs_node::contract_storage::transaction_source::{Transaction, TransactionSource};
//! use casperlabs_node::contract_storage::transaction_source::in_memory::InMemoryEnvironment;
//! use casperlabs_node::contract_storage::trie::{Pointer, PointerBlock, Trie};
//! use casperlabs_node::contract_storage::trie_store::in_memory::InMemoryTrieStore;
//! use types::bytesrepr::ToBytes;
//! use casperlabs_node::contract_shared::newtypes::Blake2bHash;
//!
//! // Create some leaves
