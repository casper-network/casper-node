...
pub(super) fn alt_bn128_mul(x: U256, y: U256, scalar: U256) -> Result<(U256, U256), AltBN128Error> {
...
pub(super) fn to_le_bytes(value: U256) -> [u8; 32] {
    let mut buf = [0u8; 32];
