...
mod rate_limit {
    ...
    async fn client_should_should_be_rate_limited_to_approx_1_qps() {
        ...
        // the     // client will eventually eat all executor threads and deadlock (at 64
        // consecutive     // requests). I believe this is happening because the server is
        // executing on the same     // tokio runtime as the client.
