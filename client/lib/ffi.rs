...
pub enum casper_error_t {
    ...
    CASPER_DEPLOY_SIZE_TOO_LARGE = -7,
    CASPER_FAILED_TO_GET_RESPONSE = -8,
    CASPER_FAILED_TO_PARSE_RESPONSE = -9,
    CASPER_FILE_ALREADY_EXISTS = -10,
    CASPER_UNSUPPORTED_ALGORITHM = -11,
    CASPER_REPSONSE_IS_ERROR = -12,
    CASPER_INVALID_JSON = -13,
    CASPER_INVALID_RPC_RESPONSE = -14,
    CASPER_FAILED_SENDING = -15,
    CASPER_IO_ERROR = -16,
    CASPER_TO_BYTES_ERROR = -17,
    CASPER_CRYPTO_ERROR = -18,
    CASPER_INVALID_CL_VALUE = -19,
    CASPER_INVALID_ARGUMENT = -20,
    CASPER_INVALID_RESPONSE = -21,
    CASPER_FFI_SETUP_NOT_CALLED = -22,
    CASPER_FFI_PTR_NULL_BUT_REQUIRED = -23,
    CASPER_CONFLICTING_ARGUMENTS = -24,
}
